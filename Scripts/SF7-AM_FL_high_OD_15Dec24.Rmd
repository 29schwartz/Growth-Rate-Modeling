...
```{r}
nested_data %>% 
  filter(Plasmid == "ev" & Condition == "OD6.6" & Replicate == 1) -> bingbong
```
...
bingbong %>%
  ...
  #facet_wrap(Plasmid ~ Condition) +
Theme

#Variant and plasmid are the same you need to get rid of one!

#The .fitted lines are adding up or interfering somehow! Need to get rid of that !
```
